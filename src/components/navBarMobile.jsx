...
const NavBarMobile = ({ selected }) => {
  ...
  return (
    <div class="navbar">
        ...
        <button class={`bar-item-mobile ${selected === 'Home' ? 'selected' : ''}`} onClick={()=>{navigate('/homepage')}}>
            <img class="bar-item-image-mobile" src={Home} alt="Home" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Search' ? 'selected' : ''}`} onClick={()=>{navigate('/search')}}>
            <img class="bar-item-image-mobile" src={Search} alt="Search" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Messages' ? 'selected' : ''}`} onClick={()=>{navigate('/messages')}}>
            <img class="bar-item-image-mobile" src={Messages} alt="Messages" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Notifications' ? 'selected' : ''}`} onClick={()=>{navigate('/notifications')}}>
            <img class="bar-item-image-mobile" src={Notifications} alt="Notifications" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Create' ? 'selected' : ''}`} onClick={()=>{navigate('/create')}}>
            <img class="bar-item-image-mobile" src={Create} alt="Create" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Profile' ? 'selected' : ''}`} onClick={()=>{navigate('/profile')}}>
            <img class="bar-item-image-mobile" src={Profile} alt="Profile" />
            </button>
            <button class={`bar-item-mobile ${selected === 'Settings' ? 'selected' : ''}`} onClick={()=>{navigate('/settings')}}>
